...
function love.load()
    ...
    player1 = Paddle(10, VIRTUAL_HEIGHT / 2 - 12, 10, 24)
    player2 = Paddle2(VIRTUAL_WIDTH - 20, VIRTUAL_HEIGHT / 2 - 12, 10, 24)
